...
transitionsColumns = ["nu", "unc1", "nu1'", "nu2'", "nu3'", "nu4'", "L3'", "L4'", "J'", "K'", "inv'", "Gamma'", "Nb'",
                      "nu1\"", "nu2\"", "nu3\"", "nu4\"", "L3\"", "L4\"", "J\"", "K\"", "inv\"", "Gamma\"", "Nb\"", "Source"]


transitions = pd.read_csv("86CoLeMarvel-Intermediate.txt", delim_whitespace=True, names=transitionsColumns)
transitions = transitions[transitions["nu"] > 0]
transitions["Matched"] = transitions["Nb'"] > 0
...
comparisonFile = "86CoLeAgainstStatesFile-MARVEL.txt"
